...
| | |
|---|---|
| **Document** | PULSE General Overview |
...
A plain SharePoint list can hold data. PULSE adds the layer on top that makes the data usable day-to-day:
