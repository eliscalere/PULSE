...
export function useAppInitialization(context) {
    var _this = this;
    var services = React.useMemo(function () { return createServices(PnPjsProvider.create(context)); }, [context]);
    ...
    React.useEffect(function () {
        ...
        void (function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, currentUser, provisioning, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = _b.sent(), currentUser = _a[0], provisioning = _a[1];
                        if (isMounted) {
                            setState({
                                services: services,
