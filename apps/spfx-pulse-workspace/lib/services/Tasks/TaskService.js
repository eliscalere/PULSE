    ...
    TaskService.prototype.getTasksByProject = function (projectId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.lists.getItems(AewttrWorkspaceConfig.lists[LIST_KEYS.tasks], [
                            'Id',
                            'Title',
                            'RelatedProjectId',
                            'TaskStatus',
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, items
                                .filter(function (item) { return Number(item.RelatedProjectId) === projectId; })
                                .map(function (item) {
                                var _a, _b;
                                return ({
                                    id: Number(item.Id),
                                    ...
                                    status: (_a = item.TaskStatus) !== null && _a !== void 0 ? _a : 'To Do',
                                    percentComplete: Number((_b = item.PercentComplete) !== null && _b !== void 0 ? _b : 0),
                                    priority: 'Medium',
