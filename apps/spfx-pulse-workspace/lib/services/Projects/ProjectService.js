    ...
    ProjectService.prototype.getProjects = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.lists.getItems(AewttrWorkspaceConfig.lists[LIST_KEYS.projects], [
                            'Id',
                            'Title',
                            'ProjectCode',
                            'ProjectHealth',
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, items.map(function (item) {
                                ...
                                return ({
                                    ...
                                    code: String((_a = item.ProjectCode) !== null && _a !== void 0 ? _a : ''),
                                    description: '',
                                    health: (_b = item.ProjectHealth) !== null && _b !== void 0 ? _b : 'Blue',
                                    status: (_c = item.ProjectStatus) !== null && _c !== void 0 ? _c : 'Not Started',
                                    priority: 'Medium',
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        projects = _a.sent();
                        return [2 /*return*/, projects.find(function (project) { return project.id === id; })];
                }
            });
        });
    };
