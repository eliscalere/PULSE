...
var DocumentService = /** @class */ (function () {
    function DocumentService(sp) {
        this.libraries = new SharePointDocumentLibraryService(sp);
    }
    DocumentService.prototype.getRecentDocuments = function () {
        return __awaiter(this, void 0, void 0, function () {
            var files;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.libraries.getFiles(AewttrWorkspaceConfig.libraries[LIBRARY_KEYS.documents])];
                    case 1:
                        files = _a.sent();
                        return [2 /*return*/, files.slice(0, 10).map(function (file, index) { return ({
                                id: index + 1,
                                title: file.Name,
                                status: 'Draft',
