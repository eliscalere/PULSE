...
var MeetingService = /** @class */ (function () {
    function MeetingService(sp) {
        this.lists = new SharePointListService(sp);
    }
    MeetingService.prototype.getRecentMeetings = function () {
        return __awaiter(this, void 0, void 0, function () {
            var items;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.lists.getItems(AewttrWorkspaceConfig.lists[LIST_KEYS.meetings], [
                            'Id',
                            'Title',
                            'MeetingDate',
                            'Summary'
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, items.map(function (item) {
                                ...
                                return ({
                                    ...
                                    meetingDate: String((_a = item.MeetingDate) !== null && _a !== void 0 ? _a : ''),
